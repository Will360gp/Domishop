...
// Este documento es para renderisar el resultado del metodo (ObtenerTodos) de la bodega
function loadDataTable() {
    datatable = $('#tblDatos').DataTable({


        //------------------------------- Con este bloque de codigo se coloca los elementos de ingles a espanol 
        "language": {
